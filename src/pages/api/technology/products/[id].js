  ...
  if (req.method === "PUT") {
    ...
    upload.single("file")(req, res, async (err) => {
      ...
      const fileData = {
        ...
        path: req.file ? `/api/uploads/technology/technologyProducts/${req.file.filename}` : file?.path,
      };
        ...
        const newFile = await SubTechnologyProduct.findOneAndUpdate({_id:id},{$set:fileData});
