  ...
  if (req.method === "PUT") {
    ...
    upload.single("file")(req, res, async (err) => {
      ...
      const fileData = {
        ...
        path: req.file ? `/api/uploads/industry/industrysolution/${req.file.filename}` : file?.path,
      };
        ...
        const newFile = await SubIndustrySolution.findOneAndUpdate({_id:id},{$set:fileData});
