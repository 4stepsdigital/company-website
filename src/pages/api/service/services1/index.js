...
const uploadDirectory = path.join(process.cwd(), "uploads/service/serviceServices"); // Define your upload directory
  ...
  if (req.method === "POST") {
    upload.single("file")(req, res, async (err) => {
      ...
      const fileData = {
        ...
        path: req.file
          ? `/api/uploads/service/serviceServices/${req.file.filename}`
          : null,
      };
